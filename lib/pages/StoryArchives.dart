...
class _storyArchivesState extends State<storyArchives> {
  ...
  createAlertDialogforImage(BuildContext context, String storyId,
      String username, String mediaUrl, String description) {
    return showDialog(
        context: context,
        builder: (context) {
          return SimpleDialog(
  ...
  Widget GridItem(BuildContext context, DocumentSnapshot document) {
    if (document["mediaType"] == "TEXT") {
      ...
      else if (document["backgroundColor"] == "grey") col = Colors.grey;
    }

    if (document["mediaType"] == "GALLERY" ||
        document["mediaType"] == "CAPTURED") {
      return Stack(
        children: <Widget>[
          Container(
            height: 208.5,
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: NetworkImage("${document["mediaUrl"]}"),
                    fit: BoxFit.fill)),
          ),
          Row(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              GestureDetector(
                onTap: () {
                  createAlertDialogforText(
                      context, document["storyId"].toString());
                },
                child: Container(
                  width: 40.0,
                  height: 40.0,
